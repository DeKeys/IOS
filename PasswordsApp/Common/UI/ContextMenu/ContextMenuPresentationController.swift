...
class ContextMenuPresentationController: UIPresentationController {
    ...
    var preferredSourceViewCorner: SourceViewCorner? {
        guard let sourceViewFrame = menu.sourceView?.frame,
            let containerView = self.containerView,
            let frame = menu.sourceView?.superview?.convert(sourceViewFrame, to: containerView)
            else { return nil}
    ...
    var presentedViewTransform: CATransform3D {
        ...
        let scale: CGFloat = menu.sourceView == nil ? 0.8 : 0.2
